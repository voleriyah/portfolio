...
<section className="w-full">
      ...
      <h1 className="font-erica uppercase self-stretch"
        ...
        >
            <h1 id="achievements" className="heading-xl" style={{ paddingTop: 'clamp(48px, calc(48px + (92px - 48px) * ((100vw - 320px) / (1920px - 320px))), 92px)', marginBottom: 'clamp(24px, calc(24px + (48px - 24px) * ((100vw - 320px) / (1920px - 320px))), 48px)' }}>Core</h1>
...
<p className="text-l" >I believe leadership is less about control and more about creating shared clarity.</p> 
       ...
       <p className="text-l" >Community work is an extension of how I lead: <b><i>by connecting people, sharing hard-earned knowledge, and strengthening the profession beyond a single company or role.</i></b></p> <br />
        ...
        >
       <img src="/images/leadership-photo.png" alt="leadership" style={{  display: 'block', marginLeft: 'auto',width: 'clamp(400px, calc(400px + (1284px - 400px) * ((100vw - 320px) / (1920px - 320px))), 1284px)', height: 'auto' }} />
